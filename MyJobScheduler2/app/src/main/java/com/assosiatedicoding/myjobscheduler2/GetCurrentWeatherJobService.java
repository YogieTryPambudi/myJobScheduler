...
public class GetCurrentWeatherJobService extends JobService {
    ...
    private void getCurrentWeather(final JobParameters job){
        ...
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                // ketika proses gagal, maka jobfinished diset dengan parameter true.Ynag artinya job perlu di reschedule
                jobFinished(job, true);
    ...
    private void showNotification(Context context, String title, String message, int notifId){
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder (context, "ChannelId")
                ...
                .setSmallIcon(R.drawable.baseline_commute_black_24dp)
